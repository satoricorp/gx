...
[3]. MCR is characterized by being informal, tool-based, and
regular [4]. The common benefits of the process are knowledge
...
working with OpenAI’s LLMs such as GPT-4 [28], [29].
...
LLMs [13]–[15], LLM prompt fine-tuning [16], fine-tuning
LLMs with human feedback [17], and LLM agents [18], [19].
...
viewBot, starting with the investigation phase on 25th Au-
...
on 7th November 2023. By 5th June 2024, Beko had adopted
CodeReviewBot across 10 projects and 22 repositories. On
24th May 2024, practitioners were informed that the commit
resolution policy was in place via an email campaign, and
20th September 2024 marked our study’s final data collection
...
TABLE I
PROJECTS INCLUDED IN OUR STUDY
Project
Explanation
# of Devel-
opers
...
tion, review comments, and commits to pull requests. To
better understand the data extraction process, we described
...
Pending
The corresponding comment is being analyzed
or waiting for some other thing.
Resolved
The corresponding comment is successful and
its suggestion was implemented.
Won’t fix
The corresponding comment is faulty or cannot
be implemented.
Closed
The corresponding comment was not implemented
...
review comments and received a survey of three questions.
...
Fig. 6. Code Review Survey
B. General Opinion Surveys
...
automation can be harmful to the organization by allowing
severe bugs to go unnoticed. Practitioners should examine
...
Foundations of Software Engineering, ser. ESEC/FSE 2013.
New
...
Foundations of Software Engineering, ser. ESEC/FSE 2022.
New
...
M. Ivankovi´c, J. Carin, M. Lewko, J. Andonov, G. Petrovi´c et al.,
“Ai-assisted assessment of coding practices in modern code review,”
in Proceedings of the 1st ACM International Conference on AI-Powered
...
with llms: Early results,” 2024.
[20] R. Tufano, O. Dabi´c, A. Mastropaolo, M. Ciniselli, and G. Bavota,
...
“Towards automating
code review activities,” in
Proceedings
of
the 43rd International Conference on Software Engineering, ser.
ICSE ’21.
IEEE Press, 2021, p. 163–174. [Online]. Available:
...
European Software Engineering Conference and Symposium on the
Foundations of Software Engineering, ser. ESEC/FSE 2019.
New
