...
import gxEnhance, { metadata as enhanceMetadata, schema as enhanceSchema } from "./tools/gx-enhance";
...
const instructions = [
  "gx MCP exposes gx_enhance and gx_review, both read-only tools.",
  ...
  "Run gx_review before shipping to check the change against the pre-ship gates and relay its ship/no-ship verdict.",
  "Use git status for inspection.",
].join(" ");

const tools: ToolModule[] = [
  defineTool(enhanceMetadata, enhanceSchema, gxEnhance),
