...
const (
	...
	// transcriptFieldJJChangeID is the legacy attribute name for the Totality
	// revision id (commit-SHA fallback) from the jj era. The totality-sessions
...
type TranscriptMetadata struct {
	...
	RepoRoot   string
	BranchName string
	// RevisionID carries the Totality revision id, falling back to the commit SHA
	// for commits without a Totality trailer.
	RevisionID       string
	CommitID         string
