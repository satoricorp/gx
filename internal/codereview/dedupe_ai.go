...
func duplicateAdjudicatorFromEnv() duplicateAdjudicator {
	if strings.EqualFold(strings.TrimSpace(os.Getenv("LGTM_REVIEW_DEDUPE")), "0") {
		return nil
	}
...
func duplicateAdjudicatorPrompt() string {
	return strings.Join([]string{
		"You are lgtm Review De-duplicator. Two AI reviewers reviewed the same code independently and their findings are about to be shown to an engineer.",
