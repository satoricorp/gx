...
func TestNormalizeOriginCanonicalizesEverySpelling(t *testing.T) {
	same := []string{
		"git@github.com:satoricorp/lgtm.git",
		"git@github.com:satoricorp/lgtm",
		"https://github.com/satoricorp/lgtm.git",
		"https://github.com/satoricorp/lgtm",
		"https://github.com/satoricorp/lgtm/",
		"ssh://git@github.com/satoricorp/lgtm.git",
		"ssh://git@github.com:22/satoricorp/lgtm.git",
		"git://github.com/satoricorp/lgtm.git",
		"https://GitHub.com/SatoriCorp/lgtm.git",
		"github.com/satoricorp/lgtm",
	}
	const want = "github.com/satoricorp/lgtm"
...
func TestNormalizeOriginDropsCredentials(t *testing.T) {
	for _, raw := range []string{
		"https://x-access-token:ghs_supersecrettoken@github.com/satoricorp/lgtm.git",
		"https://joe:hunter2@github.com/satoricorp/lgtm.git",
		"ssh://git@github.com/satoricorp/lgtm.git",
	} {
		got := NormalizeOrigin(raw)
		if got != "github.com/satoricorp/lgtm" {
...
func TestNormalizeOriginKeepsTheHost(t *testing.T) {
	cases := map[string]string{
		...
		"git@github.com:satoricorp/lgtm.git":      "github.com/satoricorp/lgtm",
...
func TestNormalizeOriginKeepsDifferentReposApart(t *testing.T) {
	distinct := []string{
		...
		"git@github.com:joe/lgtm.git",
		"git@gitlab.com:satoricorp/lgtm.git",
		"git@github.com:satoricorp/lgtm-internal.git",
	}
...
func TestNormalizeOriginRejectsUnusableInput(t *testing.T) {
	for _, raw := range []string{"", "   ", "not a url", "https://", "github.com", "/Users/joe/git/lgtm"} {
