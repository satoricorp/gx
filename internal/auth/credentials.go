...
// Credentials hold CLI upload auth for the gx server.
...
// Load reads upload credentials from env or ~/.gx/upload.json.
...
// Save persists upload credentials (used by gx login).
